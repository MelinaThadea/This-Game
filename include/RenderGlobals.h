...
public:
	...
	~RenderGlobals() = delete;
	static void setView(const ngl::Vec3 &_eye, const ngl::Vec3 &_look, const ngl::Vec3 &_up); // set the view matrix
	static void setProjections(float _fov, float _aspect, float _near = 0.1f, float _far = 100.0f);
