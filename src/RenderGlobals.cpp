...
void RenderGlobals::setView(const ngl::Vec3 &_eye, const ngl::Vec3 &_look, const ngl::Vec3 &_up) // set the view matrix
{
	s_view = ngl::lookAt(_eye, _look, _up);
}

void RenderGlobals::setProjections(float _fov, float _aspect, float _near, float _far)
{
